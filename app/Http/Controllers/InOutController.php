...
class InOutController extends Controller {
    ...
    public function index(Request $request, DataTable $dataTable) {
        ...
        return $dataTable->render('sales::in_outs.index', [ 'count' => Resource::count() ]);
    }
    ...
    public function create(Request $request) {
        ...
        // show create form
        return view('sales::in_outs.create', compact('customers', 'products'));
    }
    ...
    public function show(Resource $resource) {
        ...
        // redirect to list
        return view('sales::in_outs.show', compact('resource'));
    }
    ...
    public function edit(Resource $resource) {
        ...
        // show edit form
        return view('sales::in_outs.edit', compact('branches', 'customers', 'products', 'resource'));
    }
