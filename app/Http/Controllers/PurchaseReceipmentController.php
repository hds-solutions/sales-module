...
use HDSSolutions\Laravel\DataTables\PurchaseReceipmentsDataTable as DataTable;
...
class PurchaseReceipmentController extends Controller {
    ...
    public function index(Request $request, DataTable $dataTable) {
        ...
        return $dataTable->render('sales::purchases.receipments.index', [
    ...
    public function show(Resource $resource) {
        ...
        // redirect to list
        return view('sales::purchases.receipments.show', compact('resource'));
    }
