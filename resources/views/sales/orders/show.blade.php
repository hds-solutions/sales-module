    ...
    <div class="card-header">
        <div class="row">
            <div class="col-6 d-flex align-items-center">
                ...
                @lang('sales::orders.sales.show')
            </div>
            <div class="col-6 d-flex justify-content-end">
                @if (!$resource->wasProcessed())
                <a href="{{ route('backend.sales.orders.edit', $resource) }}"
                    class="btn btn-sm ml-2 btn-outline-info">@lang('sales::orders.sales.edit')</a>
                @endif
                <a href="{{ route('backend.sales.orders.create') }}"
                    class="btn btn-sm ml-2 btn-outline-primary">@lang('sales::orders.sales.create')</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12 col-xl-6">
                ...
                <div class="row">
                    <div class="col-4 col-lg-4">@lang('sales::order.customer_id.0'):</div>
                ...
                <div class="row">
                    <div class="col-4 col-lg-4">@lang('sales::order.in_out_id.0'):</div>
                    <div class="col-8 col-lg-6 h4"><a href="{{ route('backend.sales.in_outs.show', $resource->inOut) }}"
                            ...
                            @foreach ($resource->lines as $line)
                                ...
                                <tr class="collapse line-{{ $line->id }}-details">
                                    ...
                                    <td class="py-0 pl-3" colspan="3">
                                        <a href="{{ route('backend.sales.invoices.show', $invoiceLine->invoice) }}"
        ...
        @include('backend::components.document-actions', [
            'route'     => 'backend.sales.orders.process',
            'resource'  => $resource,
        ])
