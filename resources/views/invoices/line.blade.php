<div class="form-row mb-3 invoice-line-container" @if ($selected === null) id="new" @else data-used="true" @endif>
    <div class="col-12">
                        ...
                        <div class="form-row">
                            <div class="col-4">
                                <select name="lines[product_id][]" data-live-search="true"
                                    ...
                                    placeholder="@lang('sales::invoice.lines.product_id._')">

                                    <option value="" selected disabled
                                            hidden>@lang('sales::invoice.lines.product_id.0')</option>
                            ...
                            <div class="col-4">
                                <select name="lines[variant_id][]"
                                    ...
                                    placeholder="@lang('sales::invoice.lines.variant_id._')">

                                    <option value="" selected disabled
                                            hidden>@lang('sales::invoice.lines.variant_id.0')</option>
                            ...
                            <div class="col-4">
                                <div class="input-group">
                                    <input name="lines[price][]" type="number" min="0" thousand
                                       ...
                                       placeholder="@lang('sales::invoice.lines.price.0')">
                                    <input name="lines[quantity][]" type="number" min="1"
                                       value="{{ $selected->quantity ?? '' }}"
                                       class="form-control text-center"
                                       placeholder="@lang('sales::invoice.lines.quantity.0')">
