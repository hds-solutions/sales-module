                    ...
                    <table class="table table-sm table-striped table-borderless table-hover" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="w-150px text-center">@lang('sales::order.lines.price.0')</th>
                                <th class="w-150px text-center">@lang('sales::order.lines.quantity.0')</th>
                        ...
                        <tbody>
                            @foreach ($resource->lines as $line)
                                <tr>
                                    ...
                                    <td class="align-middle text-center h6">{{ $line->currency->code }} <b>{{ number($line->price, $line->currency->decimals) }}</b></td>
