<div class="form-row mb-3 in_out-line-container" @if ($selected === null) id="new" @else data-used="true" @endif>
    <div class="col-12">
                        ...
                        <div class="form-row">
                            <div class="col-4">
                                <select name="lines[product_id][]" data-live-search="true"
                                    ...
                                    placeholder="@lang('sales::in_out.lines.product_id._')">

                                    <option value="" selected disabled
                                            hidden>@lang('sales::in_out.lines.product_id.0')</option>
                            ...
                            <div class="col-4">
                                <select name="lines[variant_id][]"
                                    ...
                                    placeholder="@lang('sales::in_out.lines.variant_id._')">

                                    <option value="" selected disabled
                                            hidden>@lang('sales::in_out.lines.variant_id.0')</option>
                            ...
                            <div class="col-4">
                                <div class="input-group">
                                    <input name="lines[quantity_movement][]" type="number" min="1"
                                       value="{{ $selected->quantity_movement ?? '' }}"
                                       class="form-control text-center"
                                       placeholder="@lang('sales::in_out.lines.quantity_movement.0')">
                                </div>
                            </div>
